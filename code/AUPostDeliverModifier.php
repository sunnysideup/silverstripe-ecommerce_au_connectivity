...
// ######################################## *** cms variables + functions (e.g. getCMSFields, $searchableFields)
	...
	public static $singular_name = "Australian Delivery";
		function i18n_single_name() { return _t("AUPostDeliverModifier.AUSTRALIANPOSTDELIVERY", "Australian Post Delivery");}

	public static $plural_name = "Australian Deliveries";
		function i18n_plural_name() { return _t("AUPostDeliverModifier.AUSTRALIANPOSTDELIVERIES", "Australian Post Deliveries");}
...
// ######################################## *** other (non) static variables (e.g. protected static $special_name_for_something, protected $order)
	...
	protected static $allow_pick_up = false;
		static function set_allow_pick_up($b) {self::$allow_pick_up = $b;}
		static function get_allow_pick_up() {return self::$allow_pick_up;}
	...
	protected static $pickup_post_code = 2000;
		static function set_pickup_post_code($s) {self::$pickup_post_code = $s;}
		static function get_pickup_post_code() {return self::$pickup_post_code;}
	...
	protected static $assumed_dimension = 160;
		static function set_assumed_dimension($i) {self::$assumed_dimension = $i;}
		static function get_assumed_dimension() {return self::$assumed_dimension;}
	...
	protected static $minimum_weight = 0;
		static function set_minimum_weight($i) {self::$minimum_weight = $i;}
		static function get_minimum_weight() {return self::$minimum_weight;}
	...
	protected static $handling_charge = 2;
		static function set_handling_charge($f) {self::$handling_charge = $i;}
		static function get_handling_charge() {return self::$handling_charge;}
	...
	protected static $error_value = 9.99;
		static function set_error_value($f) {self::$error_value = $i;}
		static function get_error_value() {return self::$error_value;}
	...
	protected static $service_type;
		static function get_service_type() {return self::$service_type;}
		static function set_service_type($type, $isDomestic) {
...
// ######################################## *** init and update functions
	...
	public function runUpdate($force = true) {
		if (isset($_GET['debug_profile'])) Profiler::mark('AUPostDeliverModifier::runUpdate');
		...
		//this must be last!
		if (isset($_GET['debug_profile'])) Profiler::unmark('AUPostDeliverModifier::runUpdate');
		parent::runUpdate($force);
	}

	function updateIsPickUp($boolean) {
...
class AUPostDeliverModifier_Controller extends Controller {
	...
	static $url_segment = 'aupostdelivermodifier';
